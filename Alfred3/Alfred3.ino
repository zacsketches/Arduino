...
const Control_vec swerve_right = {"swerve_right", 0, 50, 0, 100, true};
const Control_vec swerve_left = {"swerve_left", 0, 100, 0, 50, true};
...
void loop() {
  ...
  int control_index = update_control(sensor_state);
  drive(control_index);
