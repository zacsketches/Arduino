/* Alfred 7 includes lessons learned in Alfred6 for Control_vec, and values in the motor
   control constants.  Also made changes in the drive function to incorporate new names 
   in the Control_vec structure.
...
const float stall_current = 1.0;                //based off config runs on 11Aug with 7.5V Alkaline battery pack.
